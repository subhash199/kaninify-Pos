...
namespace DataHandlerLibrary.Migrations
{
    ...
    [Migration("20260922230814_AddCardTransactionResponseDetails")]
    partial class AddCardTransactionResponseDetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataHandlerLibrary.Models.BusinessSetting", b =>
                {
                    ...
                    b.Property<bool>("AllowDayEndWithPendingRefills")
                        .HasColumnType("boolean");

                    b.Property<bool>("AllowShiftEndWithPendingRefill")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("PrintPayoutReceiptForEveryPayout")
                        .HasColumnType("boolean");

                    b.Property<bool>("PrintRefundReceiptForEveryRefund")
                        .HasColumnType("boolean");

                    b.Property<bool>("PrintSalesReceiptForEverySale")
                        .HasColumnType("boolean");

                    b.Property<int>("RefillEnforcement_Enabled")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DataHandlerLibrary.Models.CardTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("Epos_Instance_Id")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");

                    b.Property<string>("Gateway_Payment_Id")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.Property<string>("Progress_Status")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("Gateway_Payment_Id");

                    b.HasIndex("Idempotency_Key")
                        .IsUnique();

                    b.HasIndex("SalesTransaction_Id");

                    b.HasIndex("Transaction_Reference");

                    b.HasIndex("Provider", "Environment", "Payment_Request_Id")
                        .IsUnique();
            ...
            modelBuilder.Entity("DataHandlerLibrary.Models.PaymentTerminalSetting", b =>
                {
                    ...
                    b.Property<DateTime?>("Access_Token_Expires_At")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<bool>("Is_Pay_At_Counter_Enabled")
                        .HasColumnType("boolean");

                    b.Property<string>("Last_Known_Status")
                        .HasMaxLength(120)
                        .HasColumnType("character varying(120)");
                    ...
                    b.Property<DateTime?>("Last_Verified_At")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("Merchant_Display_Name")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.Property<string>("Store_Country")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("EntityFrameworkDatabaseLibrary.Models.Product", b =>
                {
                    ...
                    b.Property<decimal?>("Product_Size")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("DataHandlerLibrary.Models.CardTransaction", b =>
                {
                    b.HasOne("EntityFrameworkDatabaseLibrary.Models.SalesTransaction", "SalesTransaction")
                        ...
                        .HasForeignKey("SalesTransaction_Id")
