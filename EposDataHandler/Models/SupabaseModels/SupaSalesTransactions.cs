...
{
    [Table("SupaSalesTransactions")]
    public class SupaSalesTransactions
    {
        ...
        public SupaSalesTransactions()
        {
            // Initialize default values
            Date_Created = DateTimeOffset.UtcNow;
            Last_Modified = DateTimeOffset.UtcNow;
            Sale_Date = DateTimeOffset.UtcNow;
            Sale_Start_Date = DateTimeOffset.UtcNow;
